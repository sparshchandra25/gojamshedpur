  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-white border-b border-gray-100 shadow-sm" id="main-header">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        ...
        >
          <div className="w-10 h-10 bg-[#102050] rounded flex items-center justify-center transition-transform group-hover:scale-105" id="header-logo-badge">
            <Zap className="w-6 h-6 text-[#f1b42f] fill-[#f1b42f]" />
          </div>
